        ...
        arrObjObservation = result;
         if(arrObjObservation.length > 0){
             ...
             $.each(result,function(i,observation){
                let strTableRowHTML = '<tr><td>' + observation.Match + '</td><td>' + observation.TeamScouting + '</td><td>' + observation.ScoutingPosition + '</td><td>' + observation.TarmacStartingPosition + '</td><td>' + observation.AutoTarmacTaxi + '</td><td>' + observation.AutoBallPickup + '</td><td>' + observation.AutoUpperHub + '</td><td>' + observation.AutoLowerHub + '</td><td>' + observation.AutoBallsMissed+ '</td><td>' + observation.TeleOpUpperHub + '</td><td>' + observation.TeleOpLowerHub + '</td><td>' + observation.TeleOpBallsMissed + '</td><td>' + observation.TeleOpShootsBalls + '</td><td>' + observation.TeleOpPlaysDefense + '</td><td>' + observation.ClimbRP + '</td><td>' + observation.MoreQuintet + '</td><td>' + observation.Flipped + '</td><td>' + observation.Bricked + '</td><td>' + observation.MoreWin + '</td><td>' + observation.EndGameClimbing + '</td><td>' + observation.SubmittedBy + '</td><td>' + observation.ObservationDateTime + '</td></tr>';
    ...
    $.getJSON('php/getPitDataBySessionID.php?strUserSessionID=' + sessionStorage.getItem('ScoutFRCSessionID'),function(result){
        arrObjObservation = result;
         if(arrObjObservation.length > 0){
             ...
             var strCurrent = '';
             $.each(result,function(i,observation){
                 let strTableRowHTML = '<tr><td>' + observation.PitTeamNumber + '</td><td>' + observation.RobotDriveTrain + '</td><td>' + observation.ShooterType + '</td><td>' + observation.PitClimbing + '</td><td>' + observation.Notes + '</td><td>' + observation.RobotShape + '</td><td>' + observation.Height + '</td><td>' + observation.RobotHeightExtend + '</td><td>' + observation.DriveTrainMotors + '</td><td>' + observation.DriveMotorType + '</td><td>' + observation.DriveTrainWheels + '</td><td>' + observation.DriveWheelType + '</td><td>' + observation.BallCollection + '</td><td>' + observation.OverBumper + '</td><td>' + observation.ThroughBumpter + '</td><td>' + observation.IntakeExtendable + '</td><td>' + observation.IntakeInternal + '</td><td>' + observation.Turret + '</td><td>' + observation.LimeLight + '</td><td>' + observation.EnterBy + '</td><td>' + observation.EntryDateTime + '</td></tr>';
